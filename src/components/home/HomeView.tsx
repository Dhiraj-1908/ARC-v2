...
export default function HomeView({
  ...
  return (
    <div
      className={`flex-1 overflow-y-auto flex flex-col items-center justify-start px-6 pt-10 pb-12
    ...
    >
      <div className="w-full max-w-2xl flex flex-col items-center gap-6">
        ...
        {/* Banners */}
        {justLoggedIn && (
          <div className={`w-full flex items-center justify-between gap-3 px-4 py-3 rounded-2xl border
        ...
        {/* Logo + title — always below banners, never overlapping */}
        <div className="flex flex-col items-center mt-8">
          <div className="relative w-48 h-48 mb-5">
            <div className={`absolute inset-0 rounded-full ${isDarkMode ? "bg-red-500/20" : "bg-red-500/10"} blur-2xl scale-100`} />
        ...
        {/* Input card */}
        <div className={`w-full rounded-2xl border shadow-2xl overflow-hidden ${t.inputCard}`}>
          <div className="p-5">
